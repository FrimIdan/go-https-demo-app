...
type PostTestHandlerFunc func(PostTestParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostTestHandlerFunc) Handle(params PostTestParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// PostTestHandler interface for that can handle valid post test params
type PostTestHandler interface {
	Handle(PostTestParams, interface{}) middleware.Responder
}
